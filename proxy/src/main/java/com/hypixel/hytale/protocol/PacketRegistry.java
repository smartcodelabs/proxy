/*
 * Simplified PacketRegistry for Numdrassl Proxy
 * Only registers essential packets for proxy operation
 */
package com.hypixel.hytale.protocol;

import com.hypixel.hytale.protocol.io.ValidationResult;import com.hypixel.hytale.protocol.packets.asseteditor.AssetEditorActivateButton;
...
public final class PacketRegistry {
    ...
    static {
        ...
        register(28, "RequestCommonAssetsRebuild", RequestCommonAssetsRebuild.class, 0, 0, false, RequestCommonAssetsRebuild::validateStructure, RequestCommonAssetsRebuild::deserialize);
        ...
        register(41, "UpdateBlockHitboxes", UpdateBlockHitboxes.class, 6, 1677721600, true, UpdateBlockHitboxes::validateStructure, UpdateBlockHitboxes::deserialize);
        register(42, "UpdateBlockSoundSets", UpdateBlockSoundSets.class, 6, 1677721600, true, UpdateBlockSoundSets::validateStructure, UpdateBlockSoundSets::deserialize);
        register(43, "UpdateItemSoundSets", UpdateItemSoundSets.class, 6, 1677721600, true, UpdateItemSoundSets::validateStructure, UpdateItemSoundSets::deserialize);
        register(44, "UpdateBlockParticleSets", UpdateBlockParticleSets.class, 2, 1677721600, true, UpdateBlockParticleSets::validateStructure, UpdateBlockParticleSets::deserialize);
        register(45, "UpdateBlockBreakingDecals", UpdateBlockBreakingDecals.class, 2, 1677721600, true, UpdateBlockBreakingDecals::validateStructure, UpdateBlockBreakingDecals::deserialize);
        ...
        register(49, "UpdateParticleSystems", UpdateParticleSystems.class, 2, 1677721600, true, UpdateParticleSystems::validateStructure, UpdateParticleSystems::deserialize);
        register(50, "UpdateParticleSpawners", UpdateParticleSpawners.class, 2, 1677721600, true, UpdateParticleSpawners::validateStructure, UpdateParticleSpawners::deserialize);
        register(51, "UpdateEntityEffects", UpdateEntityEffects.class, 6, 1677721600, true, UpdateEntityEffects::validateStructure, UpdateEntityEffects::deserialize);
        register(52, "UpdateItemPlayerAnimations", UpdateItemPlayerAnimations.class, 2, 1677721600, true, UpdateItemPlayerAnimations::validateStructure, UpdateItemPlayerAnimations::deserialize);
        ...
        register(55, "UpdateItemQualities", UpdateItemQualities.class, 6, 1677721600, true, UpdateItemQualities::validateStructure, UpdateItemQualities::deserialize);
        register(56, "UpdateItemCategories", UpdateItemCategories.class, 2, 1677721600, true, UpdateItemCategories::validateStructure, UpdateItemCategories::deserialize);
        ...
        register(58, "UpdateFieldcraftCategories", UpdateFieldcraftCategories.class, 2, 1677721600, true, UpdateFieldcraftCategories::validateStructure, UpdateFieldcraftCategories::deserialize);
        register(59, "UpdateResourceTypes", UpdateResourceTypes.class, 2, 1677721600, true, UpdateResourceTypes::validateStructure, UpdateResourceTypes::deserialize);
        ...
        register(67, "UpdateRootInteractions", UpdateRootInteractions.class, 6, 1677721600, true, UpdateRootInteractions::validateStructure, UpdateRootInteractions::deserialize);
        register(68, "UpdateUnarmedInteractions", UpdateUnarmedInteractions.class, 2, 20480007, true, UpdateUnarmedInteractions::validateStructure, UpdateUnarmedInteractions::deserialize);
        register(69, "TrackOrUpdateObjective", TrackOrUpdateObjective.class, 1, 1677721600, false, TrackOrUpdateObjective::validateStructure, TrackOrUpdateObjective::deserialize);
        ...
        register(71, "UpdateObjectiveTask", UpdateObjectiveTask.class, 21, 16384035, false, UpdateObjectiveTask::validateStructure, UpdateObjectiveTask::deserialize);
        register(72, "UpdateEntityStatTypes", UpdateEntityStatTypes.class, 6, 1677721600, true, UpdateEntityStatTypes::validateStructure, UpdateEntityStatTypes::deserialize);
        ...
        register(74, "UpdateHitboxCollisionConfig", UpdateHitboxCollisionConfig.class, 6, 36864011, true, UpdateHitboxCollisionConfig::validateStructure, UpdateHitboxCollisionConfig::deserialize);
        register(75, "UpdateRepulsionConfig", UpdateRepulsionConfig.class, 6, 65536011, true, UpdateRepulsionConfig::validateStructure, UpdateRepulsionConfig::deserialize);
        ...
        register(80, "UpdateAudioCategories", UpdateAudioCategories.class, 6, 1677721600, true, UpdateAudioCategories::validateStructure, UpdateAudioCategories::deserialize);
        register(81, "UpdateReverbEffects", UpdateReverbEffects.class, 6, 1677721600, true, UpdateReverbEffects::validateStructure, UpdateReverbEffects::deserialize);
        register(82, "UpdateEqualizerEffects", UpdateEqualizerEffects.class, 6, 1677721600, true, UpdateEqualizerEffects::validateStructure, UpdateEqualizerEffects::deserialize);
        ...
        register(85, "UpdateProjectileConfigs", UpdateProjectileConfigs.class, 2, 1677721600, true, UpdateProjectileConfigs::validateStructure, UpdateProjectileConfigs::deserialize);
        ...
        register(103, "SetBlockPlacementOverride", SetBlockPlacementOverride.class, 1, 1, false, SetBlockPlacementOverride::validateStructure, SetBlockPlacementOverride::deserialize);
        ...
        register(110, "UpdateMovementSettings", UpdateMovementSettings.class, 252, 252, false, UpdateMovementSettings::validateStructure, UpdateMovementSettings::deserialize);
        ...
        register(116, "SyncPlayerPreferences", SyncPlayerPreferences.class, 8, 8, false, SyncPlayerPreferences::validateStructure, SyncPlayerPreferences::deserialize);
        ...
        register(118, "UpdateMemoriesFeatureStatus", UpdateMemoriesFeatureStatus.class, 1, 1, false, UpdateMemoriesFeatureStatus::validateStructure, UpdateMemoriesFeatureStatus::deserialize);
        ...
        register(134, "SetChunkEnvironments", SetChunkEnvironments.class, 9, 4096014, true, SetChunkEnvironments::validateStructure, SetChunkEnvironments::deserialize);
        ...
        register(147, "UpdateEditorTimeOverride", UpdateEditorTimeOverride.class, 14, 14, false, UpdateEditorTimeOverride::validateStructure, UpdateEditorTimeOverride::deserialize);
        register(148, "ClearEditorTimeOverride", ClearEditorTimeOverride.class, 0, 0, false, ClearEditorTimeOverride::validateStructure, ClearEditorTimeOverride::deserialize);
        register(149, "UpdateWeather", UpdateWeather.class, 8, 8, false, UpdateWeather::validateStructure, UpdateWeather::deserialize);
        register(150, "UpdateEditorWeatherOverride", UpdateEditorWeatherOverride.class, 4, 4, false, UpdateEditorWeatherOverride::validateStructure, UpdateEditorWeatherOverride::deserialize);
        register(151, "UpdateEnvironmentMusic", UpdateEnvironmentMusic.class, 4, 4, false, UpdateEnvironmentMusic::validateStructure, UpdateEnvironmentMusic::deserialize);
        register(152, "SpawnParticleSystem", SpawnParticleSystem.class, 44, 16384049, false, SpawnParticleSystem::validateStructure, SpawnParticleSystem::deserialize);
        register(153, "SpawnBlockParticleSystem", SpawnBlockParticleSystem.class, 30, 30, false, SpawnBlockParticleSystem::validateStructure, SpawnBlockParticleSystem::deserialize);
        ...
        register(156, "PlaySoundEventEntity", PlaySoundEventEntity.class, 16, 16, false, PlaySoundEventEntity::validateStructure, PlaySoundEventEntity::deserialize);
        ...
        register(165, "SpawnModelParticles", SpawnModelParticles.class, 5, 1677721600, false, SpawnModelParticles::validateStructure, SpawnModelParticles::deserialize);
        register(166, "MountMovement", MountMovement.class, 59, 59, false, MountMovement::validateStructure, MountMovement::deserialize);
        register(170, "UpdatePlayerInventory", UpdatePlayerInventory.class, 2, 1677721600, true, UpdatePlayerInventory::validateStructure, UpdatePlayerInventory::deserialize);
        ...
        register(173, "SmartGiveCreativeItem", SmartGiveCreativeItem.class, 1, 16384011, false, SmartGiveCreativeItem::validateStructure, SmartGiveCreativeItem::deserialize);
        ...
        register(178, "SwitchHotbarBlockSet", SwitchHotbarBlockSet.class, 1, 16384006, false, SwitchHotbarBlockSet::validateStructure, SwitchHotbarBlockSet::deserialize);
        ...
        register(224, "AddToServerPlayerList", AddToServerPlayerList.class, 1, 1677721600, false, AddToServerPlayerList::validateStructure, AddToServerPlayerList::deserialize);
        register(225, "RemoveFromServerPlayerList", RemoveFromServerPlayerList.class, 1, 65536006, false, RemoveFromServerPlayerList::validateStructure, RemoveFromServerPlayerList::deserialize);
        register(226, "UpdateServerPlayerList", UpdateServerPlayerList.class, 1, 131072006, false, UpdateServerPlayerList::validateStructure, UpdateServerPlayerList::deserialize);
        register(227, "UpdateServerPlayerListPing", UpdateServerPlayerListPing.class, 1, 81920006, false, UpdateServerPlayerListPing::validateStructure, UpdateServerPlayerListPing::deserialize);
        register(228, "UpdateKnownRecipes", UpdateKnownRecipes.class, 1, 1677721600, false, UpdateKnownRecipes::validateStructure, UpdateKnownRecipes::deserialize);
        register(229, "UpdatePortal", UpdatePortal.class, 6, 16384020, false, UpdatePortal::validateStructure, UpdatePortal::deserialize);
        register(230, "UpdateVisibleHudComponents", UpdateVisibleHudComponents.class, 1, 4096006, false, UpdateVisibleHudComponents::validateStructure, UpdateVisibleHudComponents::deserialize);
        register(231, "ResetUserInterfaceState", ResetUserInterfaceState.class, 0, 0, false, ResetUserInterfaceState::validateStructure, ResetUserInterfaceState::deserialize);
        ...
        register(234, "OpenChatWithCommand", OpenChatWithCommand.class, 1, 16384006, false, OpenChatWithCommand::validateStructure, OpenChatWithCommand::deserialize);
        register(240, "UpdateWorldMapSettings", UpdateWorldMapSettings.class, 16, 1677721600, false, UpdateWorldMapSettings::validateStructure, UpdateWorldMapSettings::deserialize);
        ...
        register(243, "UpdateWorldMapVisible", UpdateWorldMapVisible.class, 1, 1, false, UpdateWorldMapVisible::validateStructure, UpdateWorldMapVisible::deserialize);
        register(244, "TeleportToWorldMapMarker", TeleportToWorldMapMarker.class, 1, 16384006, false, TeleportToWorldMapMarker::validateStructure, TeleportToWorldMapMarker::deserialize);
        register(245, "TeleportToWorldMapPosition", TeleportToWorldMapPosition.class, 8, 8, false, TeleportToWorldMapPosition::validateStructure, TeleportToWorldMapPosition::deserialize);
        ...
        register(251, "UpdateServerAccess", UpdateServerAccess.class, 2, 1677721600, false, UpdateServerAccess::validateStructure, UpdateServerAccess::deserialize);
        ...
        register(260, "RequestMachinimaActorModel", RequestMachinimaActorModel.class, 1, 49152028, false, RequestMachinimaActorModel::validateStructure, RequestMachinimaActorModel::deserialize);
        register(261, "SetMachinimaActorModel", SetMachinimaActorModel.class, 1, 1677721600, false, SetMachinimaActorModel::validateStructure, SetMachinimaActorModel::deserialize);
        register(262, "UpdateMachinimaScene", UpdateMachinimaScene.class, 6, 36864033, true, UpdateMachinimaScene::validateStructure, UpdateMachinimaScene::deserialize);
        ...
        register(290, "SyncInteractionChains", SyncInteractionChains.class, 0, 1677721600, false, SyncInteractionChains::validateStructure, SyncInteractionChains::deserialize);
        register(291, "CancelInteractionChain", CancelInteractionChain.class, 5, 1038, false, CancelInteractionChain::validateStructure, CancelInteractionChain::deserialize);
        ...
        register(302, "AssetEditorInitialize", AssetEditorInitialize.class, 0, 0, false, AssetEditorInitialize::validateStructure, AssetEditorInitialize::deserialize);
        register(303, "AssetEditorAuthorization", AssetEditorAuthorization.class, 1, 1, false, AssetEditorAuthorization::validateStructure, AssetEditorAuthorization::deserialize);
        register(304, "AssetEditorCapabilities", AssetEditorCapabilities.class, 5, 5, false, AssetEditorCapabilities::validateStructure, AssetEditorCapabilities::deserialize);
        register(305, "AssetEditorSetupSchemas", AssetEditorSetupSchemas.class, 1, 1677721600, true, AssetEditorSetupSchemas::validateStructure, AssetEditorSetupSchemas::deserialize);
        register(306, "AssetEditorSetupAssetTypes", AssetEditorSetupAssetTypes.class, 1, 1677721600, false, AssetEditorSetupAssetTypes::validateStructure, AssetEditorSetupAssetTypes::deserialize);
        register(307, "AssetEditorCreateDirectory", AssetEditorCreateDirectory.class, 5, 32768024, false, AssetEditorCreateDirectory::validateStructure, AssetEditorCreateDirectory::deserialize);
        register(308, "AssetEditorDeleteDirectory", AssetEditorDeleteDirectory.class, 5, 32768024, false, AssetEditorDeleteDirectory::validateStructure, AssetEditorDeleteDirectory::deserialize);
        register(309, "AssetEditorRenameDirectory", AssetEditorRenameDirectory.class, 5, 65536051, false, AssetEditorRenameDirectory::validateStructure, AssetEditorRenameDirectory::deserialize);
        register(310, "AssetEditorFetchAsset", AssetEditorFetchAsset.class, 6, 32768025, false, AssetEditorFetchAsset::validateStructure, AssetEditorFetchAsset::deserialize);
        register(311, "AssetEditorFetchJsonAssetWithParents", AssetEditorFetchJsonAssetWithParents.class, 6, 32768025, false, AssetEditorFetchJsonAssetWithParents::validateStructure, AssetEditorFetchJsonAssetWithParents::deserialize);
        register(312, "AssetEditorFetchAssetReply", AssetEditorFetchAssetReply.class, 5, 4096010, false, AssetEditorFetchAssetReply::validateStructure, AssetEditorFetchAssetReply::deserialize);
        register(313, "AssetEditorFetchJsonAssetWithParentsReply", AssetEditorFetchJsonAssetWithParentsReply.class, 5, 1677721600, true, AssetEditorFetchJsonAssetWithParentsReply::validateStructure, AssetEditorFetchJsonAssetWithParentsReply::deserialize);
        register(314, "AssetEditorAssetPackSetup", AssetEditorAssetPackSetup.class, 1, 1677721600, false, AssetEditorAssetPackSetup::validateStructure, AssetEditorAssetPackSetup::deserialize);
        register(315, "AssetEditorUpdateAssetPack", AssetEditorUpdateAssetPack.class, 1, 1677721600, false, AssetEditorUpdateAssetPack::validateStructure, AssetEditorUpdateAssetPack::deserialize);
        register(316, "AssetEditorCreateAssetPack", AssetEditorCreateAssetPack.class, 5, 1677721600, false, AssetEditorCreateAssetPack::validateStructure, AssetEditorCreateAssetPack::deserialize);
        register(317, "AssetEditorDeleteAssetPack", AssetEditorDeleteAssetPack.class, 1, 16384006, false, AssetEditorDeleteAssetPack::validateStructure, AssetEditorDeleteAssetPack::deserialize);
        register(318, "AssetEditorEnableAssetPack", AssetEditorEnableAssetPack.class, 2, 16384007, false, AssetEditorEnableAssetPack::validateStructure, AssetEditorEnableAssetPack::deserialize);
        register(319, "AssetEditorAssetListSetup", AssetEditorAssetListSetup.class, 4, 1677721600, true, AssetEditorAssetListSetup::validateStructure, AssetEditorAssetListSetup::deserialize);
        register(320, "AssetEditorAssetListUpdate", AssetEditorAssetListUpdate.class, 1, 1677721600, true, AssetEditorAssetListUpdate::validateStructure, AssetEditorAssetListUpdate::deserialize);
        register(321, "AssetEditorRequestChildrenList", AssetEditorRequestChildrenList.class, 1, 32768020, false, AssetEditorRequestChildrenList::validateStructure, AssetEditorRequestChildrenList::deserialize);
        register(322, "AssetEditorRequestChildrenListReply", AssetEditorRequestChildrenListReply.class, 1, 1677721600, false, AssetEditorRequestChildrenListReply::validateStructure, AssetEditorRequestChildrenListReply::deserialize);
        register(323, "AssetEditorUpdateJsonAsset", AssetEditorUpdateJsonAsset.class, 9, 1677721600, true, AssetEditorUpdateJsonAsset::validateStructure, AssetEditorUpdateJsonAsset::deserialize);
        register(324, "AssetEditorUpdateAsset", AssetEditorUpdateAsset.class, 9, 53248050, false, AssetEditorUpdateAsset::validateStructure, AssetEditorUpdateAsset::deserialize);
        register(325, "AssetEditorJsonAssetUpdated", AssetEditorJsonAssetUpdated.class, 1, 1677721600, false, AssetEditorJsonAssetUpdated::validateStructure, AssetEditorJsonAssetUpdated::deserialize);
        register(326, "AssetEditorAssetUpdated", AssetEditorAssetUpdated.class, 1, 36864033, false, AssetEditorAssetUpdated::validateStructure, AssetEditorAssetUpdated::deserialize);
        register(327, "AssetEditorCreateAsset", AssetEditorCreateAsset.class, 10, 53248051, false, AssetEditorCreateAsset::validateStructure, AssetEditorCreateAsset::deserialize);
        register(328, "AssetEditorRenameAsset", AssetEditorRenameAsset.class, 5, 65536051, false, AssetEditorRenameAsset::validateStructure, AssetEditorRenameAsset::deserialize);
        register(329, "AssetEditorDeleteAsset", AssetEditorDeleteAsset.class, 5, 32768024, false, AssetEditorDeleteAsset::validateStructure, AssetEditorDeleteAsset::deserialize);
        register(330, "AssetEditorDiscardChanges", AssetEditorDiscardChanges.class, 1, 1677721600, false, AssetEditorDiscardChanges::validateStructure, AssetEditorDiscardChanges::deserialize);
        register(331, "AssetEditorFetchAutoCompleteData", AssetEditorFetchAutoCompleteData.class, 5, 32768023, false, AssetEditorFetchAutoCompleteData::validateStructure, AssetEditorFetchAutoCompleteData::deserialize);
        register(332, "AssetEditorFetchAutoCompleteDataReply", AssetEditorFetchAutoCompleteDataReply.class, 5, 1677721600, false, AssetEditorFetchAutoCompleteDataReply::validateStructure, AssetEditorFetchAutoCompleteDataReply::deserialize);
        register(333, "AssetEditorRequestDataset", AssetEditorRequestDataset.class, 1, 16384006, false, AssetEditorRequestDataset::validateStructure, AssetEditorRequestDataset::deserialize);
        register(334, "AssetEditorRequestDatasetReply", AssetEditorRequestDatasetReply.class, 1, 1677721600, false, AssetEditorRequestDatasetReply::validateStructure, AssetEditorRequestDatasetReply::deserialize);
        register(335, "AssetEditorActivateButton", AssetEditorActivateButton.class, 1, 16384006, false, AssetEditorActivateButton::validateStructure, AssetEditorActivateButton::deserialize);
        register(336, "AssetEditorSelectAsset", AssetEditorSelectAsset.class, 1, 32768020, false, AssetEditorSelectAsset::validateStructure, AssetEditorSelectAsset::deserialize);
        register(337, "AssetEditorPopupNotification", AssetEditorPopupNotification.class, 2, 1677721600, false, AssetEditorPopupNotification::validateStructure, AssetEditorPopupNotification::deserialize);
        register(338, "AssetEditorFetchLastModifiedAssets", AssetEditorFetchLastModifiedAssets.class, 0, 0, false, AssetEditorFetchLastModifiedAssets::validateStructure, AssetEditorFetchLastModifiedAssets::deserialize);
        register(339, "AssetEditorLastModifiedAssets", AssetEditorLastModifiedAssets.class, 1, 1677721600, false, AssetEditorLastModifiedAssets::validateStructure, AssetEditorLastModifiedAssets::deserialize);
        register(340, "AssetEditorModifiedAssetsCount", AssetEditorModifiedAssetsCount.class, 4, 4, false, AssetEditorModifiedAssetsCount::validateStructure, AssetEditorModifiedAssetsCount::deserialize);
        register(341, "AssetEditorSubscribeModifiedAssetsChanges", AssetEditorSubscribeModifiedAssetsChanges.class, 1, 1, false, AssetEditorSubscribeModifiedAssetsChanges::validateStructure, AssetEditorSubscribeModifiedAssetsChanges::deserialize);
        register(342, "AssetEditorExportAssets", AssetEditorExportAssets.class, 1, 1677721600, false, AssetEditorExportAssets::validateStructure, AssetEditorExportAssets::deserialize);
        register(343, "AssetEditorExportAssetInitialize", AssetEditorExportAssetInitialize.class, 6, 81920066, false, AssetEditorExportAssetInitialize::validateStructure, AssetEditorExportAssetInitialize::deserialize);
        register(344, "AssetEditorExportAssetPart", AssetEditorExportAssetPart.class, 1, 4096006, true, AssetEditorExportAssetPart::validateStructure, AssetEditorExportAssetPart::deserialize);
        register(345, "AssetEditorExportAssetFinalize", AssetEditorExportAssetFinalize.class, 0, 0, false, AssetEditorExportAssetFinalize::validateStructure, AssetEditorExportAssetFinalize::deserialize);
        register(346, "AssetEditorExportDeleteAssets", AssetEditorExportDeleteAssets.class, 1, 1677721600, false, AssetEditorExportDeleteAssets::validateStructure, AssetEditorExportDeleteAssets::deserialize);
        register(347, "AssetEditorExportComplete", AssetEditorExportComplete.class, 1, 1677721600, false, AssetEditorExportComplete::validateStructure, AssetEditorExportComplete::deserialize);
        register(348, "AssetEditorRebuildCaches", AssetEditorRebuildCaches.class, 5, 5, false, AssetEditorRebuildCaches::validateStructure, AssetEditorRebuildCaches::deserialize);
        register(349, "AssetEditorUndoChanges", AssetEditorUndoChanges.class, 5, 32768024, false, AssetEditorUndoChanges::validateStructure, AssetEditorUndoChanges::deserialize);
        register(350, "AssetEditorRedoChanges", AssetEditorRedoChanges.class, 5, 32768024, false, AssetEditorRedoChanges::validateStructure, AssetEditorRedoChanges::deserialize);
        register(351, "AssetEditorUndoRedoReply", AssetEditorUndoRedoReply.class, 5, 1677721600, false, AssetEditorUndoRedoReply::validateStructure, AssetEditorUndoRedoReply::deserialize);
        register(352, "AssetEditorSetGameTime", AssetEditorSetGameTime.class, 14, 14, false, AssetEditorSetGameTime::validateStructure, AssetEditorSetGameTime::deserialize);
        register(353, "AssetEditorUpdateSecondsPerGameDay", AssetEditorUpdateSecondsPerGameDay.class, 8, 8, false, AssetEditorUpdateSecondsPerGameDay::validateStructure, AssetEditorUpdateSecondsPerGameDay::deserialize);
        register(354, "AssetEditorUpdateWeatherPreviewLock", AssetEditorUpdateWeatherPreviewLock.class, 1, 1, false, AssetEditorUpdateWeatherPreviewLock::validateStructure, AssetEditorUpdateWeatherPreviewLock::deserialize);
        register(355, "AssetEditorUpdateModelPreview", AssetEditorUpdateModelPreview.class, 30, 1677721600, false, AssetEditorUpdateModelPreview::validateStructure, AssetEditorUpdateModelPreview::deserialize);
        ...
        register(361, "UpdatePostFxSettings", UpdatePostFxSettings.class, 20, 20, false, UpdatePostFxSettings::validateStructure, UpdatePostFxSettings::deserialize);
        register(400, "BuilderToolArgUpdate", BuilderToolArgUpdate.class, 14, 32768032, false, BuilderToolArgUpdate::validateStructure, BuilderToolArgUpdate::deserialize);
        register(401, "BuilderToolEntityAction", BuilderToolEntityAction.class, 5, 5, false, BuilderToolEntityAction::validateStructure, BuilderToolEntityAction::deserialize);
        register(402, "BuilderToolSetEntityTransform", BuilderToolSetEntityTransform.class, 54, 54, false, BuilderToolSetEntityTransform::validateStructure, BuilderToolSetEntityTransform::deserialize);
        register(403, "BuilderToolExtrudeAction", BuilderToolExtrudeAction.class, 24, 24, false, BuilderToolExtrudeAction::validateStructure, BuilderToolExtrudeAction::deserialize);
        register(404, "BuilderToolStackArea", BuilderToolStackArea.class, 41, 41, false, BuilderToolStackArea::validateStructure, BuilderToolStackArea::deserialize);
        register(405, "BuilderToolSelectionTransform", BuilderToolSelectionTransform.class, 52, 16384057, false, BuilderToolSelectionTransform::validateStructure, BuilderToolSelectionTransform::deserialize);
        register(406, "BuilderToolRotateClipboard", BuilderToolRotateClipboard.class, 5, 5, false, BuilderToolRotateClipboard::validateStructure, BuilderToolRotateClipboard::deserialize);
        register(407, "BuilderToolPasteClipboard", BuilderToolPasteClipboard.class, 12, 12, false, BuilderToolPasteClipboard::validateStructure, BuilderToolPasteClipboard::deserialize);
        register(408, "BuilderToolSetTransformationModeState", BuilderToolSetTransformationModeState.class, 1, 1, false, BuilderToolSetTransformationModeState::validateStructure, BuilderToolSetTransformationModeState::deserialize);
        register(409, "BuilderToolSelectionUpdate", BuilderToolSelectionUpdate.class, 24, 24, false, BuilderToolSelectionUpdate::validateStructure, BuilderToolSelectionUpdate::deserialize);
        register(410, "BuilderToolSelectionToolAskForClipboard", BuilderToolSelectionToolAskForClipboard.class, 0, 0, false, BuilderToolSelectionToolAskForClipboard::validateStructure, BuilderToolSelectionToolAskForClipboard::deserialize);
        register(411, "BuilderToolSelectionToolReplyWithClipboard", BuilderToolSelectionToolReplyWithClipboard.class, 1, 139264019, true, BuilderToolSelectionToolReplyWithClipboard::validateStructure, BuilderToolSelectionToolReplyWithClipboard::deserialize);
        register(412, "BuilderToolGeneralAction", BuilderToolGeneralAction.class, 1, 1, false, BuilderToolGeneralAction::validateStructure, BuilderToolGeneralAction::deserialize);
        register(413, "BuilderToolOnUseInteraction", BuilderToolOnUseInteraction.class, 57, 57, false, BuilderToolOnUseInteraction::validateStructure, BuilderToolOnUseInteraction::deserialize);
        register(414, "BuilderToolLineAction", BuilderToolLineAction.class, 24, 24, false, BuilderToolLineAction::validateStructure, BuilderToolLineAction::deserialize);
        register(415, "BuilderToolShowAnchor", BuilderToolShowAnchor.class, 12, 12, false, BuilderToolShowAnchor::validateStructure, BuilderToolShowAnchor::deserialize);
        register(416, "BuilderToolHideAnchors", BuilderToolHideAnchors.class, 0, 0, false, BuilderToolHideAnchors::validateStructure, BuilderToolHideAnchors::deserialize);
        ...
        register(418, "BuilderToolsSetSoundSet", BuilderToolsSetSoundSet.class, 4, 4, false, BuilderToolsSetSoundSet::validateStructure, BuilderToolsSetSoundSet::deserialize);
        register(419, "BuilderToolLaserPointer", BuilderToolLaserPointer.class, 36, 36, false, BuilderToolLaserPointer::validateStructure, BuilderToolLaserPointer::deserialize);
        register(420, "BuilderToolSetEntityScale", BuilderToolSetEntityScale.class, 8, 8, false, BuilderToolSetEntityScale::validateStructure, BuilderToolSetEntityScale::deserialize);
        register(421, "BuilderToolSetEntityPickupEnabled", BuilderToolSetEntityPickupEnabled.class, 5, 5, false, BuilderToolSetEntityPickupEnabled::validateStructure, BuilderToolSetEntityPickupEnabled::deserialize);
        register(422, "BuilderToolSetEntityLight", BuilderToolSetEntityLight.class, 9, 9, false, BuilderToolSetEntityLight::validateStructure, BuilderToolSetEntityLight::deserialize);
        register(423, "BuilderToolSetNPCDebug", BuilderToolSetNPCDebug.class, 5, 5, false, BuilderToolSetNPCDebug::validateStructure, BuilderToolSetNPCDebug::deserialize);
    }
